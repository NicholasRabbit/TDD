...
/**
 * In order to keep the legacy code to compare with the refactored code, I build a new project where most code
 * is same except those in SingleValueOptionParser and BooleanParserRefactored.
 * */
